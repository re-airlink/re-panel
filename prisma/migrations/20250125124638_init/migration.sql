/*
  ...
  - You are about to drop the column `copyright` on the `settings` table. All the data in the column will be lost.
  - You are about to drop the column `footer` on the `settings` table. All the data in the column will be lost.
...
CREATE TABLE "new_settings" (
    ...
    "favicon" TEXT NOT NULL DEFAULT '../assets/logo.ico',
